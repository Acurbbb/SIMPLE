...
% open output file
output_folder = './your_output_path'; % specify a folder for output
save_dir = fullfile(output_folder, ['tric_SPLIT_rej_pa_no_aa_tsr', num2str(tsr),'x_en', num2str(annihEn(1)),'-',num2str(annihEn(2)),'_',num2str(pGammaEn(1)),...
